...
exports.DEFAULT_NARRATIVE_STRENGTH = exports.NARRATIVE_TAGS = void 0;
exports.detectNarrative = detectNarrative;
exports.calculateNarrativeScore = calculateNarrativeScore;
// ─── Narrative tags ───────────────────────────────────────────────────────────
exports.NARRATIVE_TAGS = [
...
exports.DEFAULT_NARRATIVE_STRENGTH = {
...
function detectNarrative(symbol, name) {
...
function calculateNarrativeScore(input) {
    const tag = detectNarrative(input.symbol, input.name);
    const strength = input.narrativeStrength ?? exports.DEFAULT_NARRATIVE_STRENGTH[tag] ?? 0;
    // Base score: how prominent is this narrative overall
    const baseScore = exports.DEFAULT_NARRATIVE_STRENGTH[tag] ?? 0;
